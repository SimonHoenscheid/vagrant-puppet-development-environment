...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "postgres-puppetdb" do |postgres_puppetdb|
		postgres_puppetdb.vm.box = "SimonHoenscheid/debian8-puppet4"
		postgres_puppetdb.vm.box_url = "https://atlas.hashicorp.com/SimonHoenscheid/debian8-puppet4"
		...
		postgres_puppetdb.vm.provision :shell, :path => "installation/install-puppetdb-postgresV4.sh"
  ...
  config.vm.define "puppetdb" do |puppetdb|
		puppetdb.vm.box = "SimonHoenscheid/debian8-puppet4"
		puppetdb.vm.box_url = "https://atlas.hashicorp.com/SimonHoenscheid/debian8-puppet4"
		...
		puppetdb.vm.provision :shell, :path => "installation/install-puppetdbV4.sh"
  ...
  config.vm.define "puppetclient01" do |pc01|
		pc01.vm.box = "SimonHoenscheid/debian8-puppet4"
		pc01.vm.box_url = "https://atlas.hashicorp.com/SimonHoenscheid/debian8-puppet4"
		...
		pc01.vm.provision :shell, :path => "installation/install-puppetclientV4.sh"
